        ...
        <form>
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mdAdd-experienceWorkLabel">Añadir experiencia laboral</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            <div class="form-group">
                                <label class="control-label form-control-sm">Área profesional<span class="text-danger">*</span></label>
                                <select id="" class="form-select form-select-sm" data-placeholder="Seleccióne">
                                    ...
                                    <option value="Mercadotecnia / Publicidad / Comunicación">Mercadotecnia / Publicidad / Comunicación</option>
                        ...
                        <div id="profession-collaborator-Help" class="form-text">* Complete los datos de su experiencia laboral, de la más reciente a la más antigua.</div>
                    </div>
                </div>
