    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <p class="text-justify fs-6 fw-light lh-sm">La información de capacitación y estudios realizados, será utilizada para los fines de recategorización, reestructuración y ascensos de puestos.</p>
        </div>
        <div class="card-body">
          <div class="overflow-scroll" style="height: 25rem;">
            <code class="text-secondary">
              ...
              c) Estado civil, especificando los nombres y apellidos del cónyuge o conviviente, de ser el caso. d) Profesión u oficio.<br>
              e) Ocupación y/o cargo en el sujeto obligado.<br>
              f) Domicilio y número telefónico personales.<br>
              g) Estudios profesionales y capacitaciones especializadas recibidas.<br>
              h) Información sobre sus antecedentes policiales y penales.<br>
              ...
              <h6 style="text-align: center;"><strong>Publicado el 31/03/2021</strong></h6><br>
              ...
              <ul>
                <li>Que los datos y demás información consignada en el presente documento son verdaderos y actuales, obligándome frente a MSP S.A. a presentarla anualmente, con los datos actualizados a la fecha de presentación, en concordancia con la Resolución SBS N° 789-2018. Asimismo, autorizo a la empresa la verificación de la presente información.</li>
                <li>No tener deudas vencidas mayores a ciento veinte (120) días ni créditos castigados.</li>
                <li>No registrar información en el Registro de Deudores Aliementarios Morosos (REDAM), ni en el Registro de Deudores de Reparaciones Civiles (REDERECI).</li>
                <li>No tener antecedentes policiales, penales ni judiciales.</li>
                <li>Que, a la firma del presente documento he recibido la versión impresa del Código de Ética y Conducta de MSP. Asimismo, declaro conocer que dicho Código de Conducta es de obligatorio cumplimiento y que si trasgredo sus disposiciones seré pasible de sanción por parte de MSP S.A.</li>
                <li>He recibido y conozco todos los alcances del Reglamento Interno de Trabajo.</li>
                <li>S/NO Tengo vínculo de parentesco dentro del segundo grado de consanguidad o segundo de afinidad con algún director, trabajador, locador o practicante de MSP.</li>
                <li>Afirmo mi consentimiento y autorización del uso de sus datos personales expuestos, dentro del marco de la Ley de Protección de Datos Personales N°29733.</li>
              </ul>

              ACEPTO Y SUSCRIPCIÓN
              FECHA EN LA QUE SE REALIZA EL FORMULARIO :
